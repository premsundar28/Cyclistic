...
def analyze_ride_duration(df):
    ...
    plt.savefig('ride_duration_hist_log.png')
    plt.close()
...
def analyze_time_based(df):
    ...
    plt.ylabel('Count')
    plt.savefig('rides_per_month.png')
    plt.close()
...
def analyze_stations(df):
    ...
    plt.tight_layout()
    plt.savefig('top_stations_casual.png')
    plt.close()
    ...
    plt.xlabel('Number of Rides')
    plt.tight_layout()
    plt.savefig('top_stations_member.png')
    plt.close()
...
if __name__ == "__main__":
    file_path = "/Users/premsundar/Downloads/DA/cyclist/master.csv"

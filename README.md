...
1.  **Ride Duration & Distance:**
    *   **Casual riders** take significantly longer rides on average compared to **annual members**.
    *   The data is heavily right-skewed, with a few very long trips pulling the average up.
    *   Minimum ride distance is 0.0, suggesting "circular trips" (start and end at the same dock), which can be valid leisure rides.
    *   ![Ride Duration Distribution](img/ride%20min.png)
    *   ![Ride Distance Distribution](img/ride%20distance.png)

2.  **Usage Patterns by Time:**
    *   **Rides per Month:** Both groups show strong seasonality, peaking in summer months.
    *   **Rides per Day of the Week:** Members dominate on weekdays, while casual riders' usage surges on weekends.
    *   **Rides per Hour:** Members show clear commute peaks, while casual riders' usage is more spread out.
    *   ![Rides per Day](img/per%20day.png)
    *   ![Rides per Month](img/per%20month.png)
    *   ![Rides per Hour](img/rises%20per%20hour.png)

3.  **Station Analysis:**
    *   The most popular stations for **casual riders** are clustered around tourist attractions and parks.
    *   Top stations for **annual members** are in residential and commercial areas.
    *   ![Top Stations](img/top%20stations.png)
